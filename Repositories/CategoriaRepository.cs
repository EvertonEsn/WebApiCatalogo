...
public class CategoriaRepository : Repository<Categoria>, ICategoriaRepository
{
    ...
    public async Task<PagedList<Categoria>> GetCategoriasAsync(CategoriasParameters  categoriasParams)
    {
        ...
        var categoriasOrdenado = categorias.OrderBy(c => c.CategoriaId).AsQueryable();
        
        var resultado = PagedList<Categoria>.ToPagedList(categoriasOrdenado, categoriasParams.PageNumber, categoriasParams.PageSize);
